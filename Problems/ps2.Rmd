...
**Instructions**: 
- Complete all problems below, showing your work where appropriate.
- Submit both your written answers and R code.
- For Problems 1-3, provide clear, concise explanations in your own words.
- For Problem 4, include all R code and visualizations.
...
3. A linear regression line (the BLP)
...
**4b. Fitting and Interpreting the BLP**

Fit the Best Linear Predictor (linear regression) predicting democracy from wealth. Report and interpret the coefficients.
...
**4c. Comparing BLP to Simple CEF Approximation**
...
**4d. Theoretical Reflection and Model Extension**
