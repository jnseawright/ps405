...
We call $\mathbb{X} (\mathbb{X}^T\mathbb{X})^{-1}\mathbb{X}^T$ the *projection matrix* ($\mathbb{P_X}$) or the *hat matrix* ($\mathbb{H}$).
...
![Outlier1](Images/Brady1.png)


---

![Outlier2](Images/Brady2.png)

---

![Outlier3](Images/Brady3.png)
---

![Outlier4](Images/Brady4.png)
