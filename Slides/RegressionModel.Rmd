...
```{r, echo = FALSE, eval=TRUE, out.width="60%", fig.retina = 1, fig.align='center'}
demeconplot.shapes 
```
...
demlm.summary <- modelsummary( list("Modernization and Latitude" = dem.lm),
             output = "kableExtra",
             stars = TRUE,
             statistic = "std.error",  
             coef_rename = TRUE,
...
* If the CEF involves multiple predictor variables, the model will involve a relationship through a scatterplot in a space that is more than two-dimensional.
